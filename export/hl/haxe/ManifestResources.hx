...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_tilemap_packed_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_music_something_mp3 extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_music_something_ogg extends null { }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_sounds_music_mp3 extends null { }
